    ...
    public static void main(String args[]){
        ...
        switch(ch){
            ...
            case 'c':
                ...
                String[] materials = ConstructionCost.getMaterialsList();
                ...
                System.out.println(ConstructionCost.calculateConstructionCost(materials[selectMaterial], area, requireAutomation));
                break;
